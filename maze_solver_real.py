...
class MazeSolverSim:
    ...
    def turn_in_place(self):
        ...
        self.cmd_vel_pub.publish(Twist())
        twist = Twist()
        print(self.lidar[270])
        #ratio = self.lidar[359] / self.lidar[315]
        #if ratio > math.cos(math.radians(359-315)): #if the side lidar point is shorter than expected (there is a wall to the right)
        twist.angular.z = 0.6
        print('hello')
        #else: twist.angular.z = -0.6
